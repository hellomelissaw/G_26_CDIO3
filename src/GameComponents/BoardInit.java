...
public class BoardInit {
    public void initializeDeeds(){
        ...
        boardDeed[10] = new Deed(2,"Rullebrettparken Skaterparken");
        boardDeed[11] = new Deed(2,"Svømmebassenget");
        boardDeed[12] = new Deed(0,"Gratis Parkering");
        ...
        boardDeed[18] = new Deed(0,"Gå i Fængsel");
        boardDeed[19] = new Deed(4,"Bowlinghallen");
